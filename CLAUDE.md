...
| Performance | `prompts/performance-agent.md` | Reviews XRD for architectural performance risks, reviews code for implementation bottlenecks |
| Design | `prompts/design-agent.md` | Owns the visual layer — reactive specialist, runs on design-pass milestones and in Stage 10 enforcement against `design-tokens.md` |
...
**Middle loop (orchestrator + sdm-agent):** Context Amnesia, Heresy, Precondition Ghost, Closed-Loop Build, Confidence Bluff, Heroic Unblock, Token Drift.
